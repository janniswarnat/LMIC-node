...
#ifndef BSF_NODEMCU_32S_NORVI_H_
#define BSF_NODEMCU_32S_NORVI_H_

#include "LMIC-node.h"

#define DEVICEID_DEFAULT "nodemcu-32s-norvi"  // Default deviceid value
...
const lmic_pinmap lmic_pins = {
    ...
    .rst =5,
    .dio = { /*dio0*/ 4, /*dio1*/ 15, /*dio2*/ LMIC_UNUSED_PIN }
#ifdef MCCI_LMIC
    ,
    .rxtx_rx_active = 0,
    .rssi_cal = 10,
